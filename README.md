...
[Rock v0.1.5](https://github.com/Champii/Rock/releases/download/v0.1.5/rock) (Tested on arch linux)

``` sh
wget https://github.com/Champii/Rock/releases/download/v0.1.5/rock
chmod +x rock
./rock -V
```

...
[![Rust](https://github.com/Champii/Rock/actions/workflows/rust.yml/badge.svg?branch=tmp)](https://github.com/Champii/Rock/actions/workflows/rust.yml)
...
[Rock v0.2.2-tmp](https://github.com/Champii/Rock/releases/download/v0.2.2-tmp/rock) (Tested on arch, btw)

``` sh
wget https://github.com/Champii/Rock/releases/download/v0.2.2-tmp/rock
chmod +x rock
./rock -V
```

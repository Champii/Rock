# Rock v0.2.4-fix-parser-out-of-bounds

[![Rust](https://github.com/Champii/Rock/actions/workflows/rust.yml/badge.svg?branch=fix_parser_out_of_bounds)](https://github.com/Champii/Rock/actions/workflows/rust.yml)
...
- [Rock v0.2.4-fix-parser-out-of-bounds](#rock-v0.2.4-fix-parser-out-of-bounds)
  - [Index](#index)
  - [Features](#features)
  - [Install](#install)
...
[Rock v0.2.4-fix-parser-out-of-bounds](https://github.com/Champii/Rock/releases/download/v0.2.4-fix-parser-out-of-bounds/rock) (Tested on arch, btw)

``` sh
wget https://github.com/Champii/Rock/releases/download/v0.2.4-fix-parser-out-of-bounds/rock
chmod +x rock
./rock -V
```

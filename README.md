...
[Rock v0.1.4-fix_cargo_version](https://github.com/Champii/Rock/releases/download/v0.1.4-fix_cargo_version}/rock) (Tested on arch linux)

``` sh
wget https://github.com/Champii/Rock/releases/download/v0.1.4-fix_cargo_version/rock
chmod +x rock
./rock -V
```

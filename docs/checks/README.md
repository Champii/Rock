...
fences through the tree-sitter CLI using `docs/theme/highlights.scm` against
the real Rock syntax tree. Generated parser files are ignored, so generation is

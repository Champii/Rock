...
Rock is under active development. This book describes the language implemented in this repository, calls out current limitations, and avoids compiler-only mechanisms that ordinary programs should not use.

Use the left and right arrow keys to move between pages, press `S` to focus search, or use the chapter list in the sidebar.

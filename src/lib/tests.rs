...
#[test]
fn testcases_fails_dupl_fun_decl_main() {
    run("testcases/fails/dupl_fun_decl/main.rk", include_str!("testcases/fails/dupl_fun_decl/main.rk"), include_str!("testcases/fails/dupl_fun_decl/main.rk.out"), include_str!("testcases/fails/dupl_fun_decl/main.rk.stdout"));
}
